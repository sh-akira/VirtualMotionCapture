...
1. 成功と表示されたらOKを押します  
![LIV1a](https://rawcdn.githack.com/sh-akira/VirtualMotionCapture/37dfe094233cb8021cf43917190496a7e8526186/docs/images/manual/VMT/3-1a.png)
1. SteamVRが再起動を求める画面が出ているのでSteamVRを再起動を押します  
![LIV1b](https://rawcdn.githack.com/sh-akira/VirtualMotionCapture/37dfe094233cb8021cf43917190496a7e8526186/docs/images/manual/VMT/3-1a.png)
1. SteamVRが再起動したらLIVコンポジターを起動するを押します  
![LIV1b](https://rawcdn.githack.com/sh-akira/VirtualMotionCapture/37dfe094233cb8021cf43917190496a7e8526186/docs/images/manual/VMT/3-2.png)
