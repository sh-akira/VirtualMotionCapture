...
<span style="color: red;">※現在LIVにVMC_Cameraが表示されない問題が発生しています。VMC_Cameraの代わりにOBS Virtual Camera等でVMCの映像を入力して回避することが出来ます。</span>  
<span style="color: red;">※鋭意修正中ですが、突然動かなくなった理由についてはLIVに問い合わせください</span>  
