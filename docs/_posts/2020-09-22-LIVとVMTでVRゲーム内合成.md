...
![VMC_Cameraインストールボタン](../images/manual/VMT/2-1.png)  
![VMC_CameraインストールUAC1](../images/manual/VMT/2-1a.png)  
![VMC_CameraインストールUAC2](../images/manual/VMT/2-1b.png)
1. インストールに成功と表示されるのを確認してOKを押します  
![VMC_Cameraインストール成功](../images/manual/VMT/2-2.png)
1. 解像度設定で<span style="color: red;">1280x720/60Hz</span>を選択し適用を押します  
![解像度設定](../images/manual/VMT/2-3.png)
...
![VMC4](../images/manual/VMT/4-4.png)
1. マイクの音声で口を動かしたい場合はリップシンクタブで使用するマイクデバイスを選択します  
![VMC5](../images/manual/VMT/4-5.png)
...
![VMC6](../images/manual/VMT/4-6.png)
1. 最後に設定の保存を行います。保存先は分かりやすいフォルダを選択してください  
![VMC7](../images/manual/VMT/4-7.png)
...
1. キャリブレーションボタンを押します  
![キャリブレーション1](../images/manual/VMT/5-1.png)
1. モード選択は必ず<span style="color: red;">MR合成モード</span>を選んでください。通常は1つ目のMR合成モードです  
![キャリブレーション2](../images/manual/VMT/5-2.png)
...
![キャリブレーション3](../images/manual/VMT/5-3.png)
...
![ゲーム起動1](../images/manual/VMT/6-1.png)
1. ここまで全て正しく設定が行われていれば、このようにゲームと合成された画面が表示されます(画面はSUPER HOT VR)  
![ゲーム起動2](../images/manual/VMT/6-2.png)
...
![ゲーム起動3](../images/manual/VMT/4-4.png)
...
![OBS5](../images/manual/VMT/7-5.png)
1. 以上で設定完了です。配信を行う場合は配信先設定を、録画なら初期設定ではビデオフォルダに動画が出力されます  
![OBS6](../images/manual/VMT/7-6.png)
