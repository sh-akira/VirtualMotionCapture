//This file is based on SteamVR Plugin 1.2.3
    ...
    public class Device
    {
        ...
        public void Update()
        {
            if (Time.frameCount != prevFrameCount)
            {
                ...
                if (system != null)
                {
                    valid = system.GetControllerStateWithPose(ETrackingUniverseOrigin.TrackingUniverseStanding, index, ref state, (uint)System.Runtime.InteropServices.Marshal.SizeOf(typeof(VRControllerState_t)), ref pose);
                    UpdateHairTrigger();
                }
            }
        }
