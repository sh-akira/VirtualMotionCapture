...
namespace Assets.Scripts
{
    public static class NativeMethods
    {
        ...
        {
            return GetUnityWindowHandle() == GetActiveWindow();
        }
        ...
        public static void ActiveWindow(IntPtr hWnd)
        {
            ...
            SetWindowPos(hWnd, HWND_TOP, 0, 0, 0, 0, SetWindowPosFlags.IgnoreMove | SetWindowPosFlags.IgnoreResize | SetWindowPosFlags.ShowWindow | SetWindowPosFlags.AsynchronousWindowPosition);
